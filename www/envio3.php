...
$headers = 'MIME-Version: 1.0' . "\r\n";
			...
			$bodymail .='<title>Nuevo pedido</title>';
			$bodymail .='<style>';
			...
			$bodymail .='<div class="content-datos2" style="width: 100%;display: inline-block;"><p style="text-align: center;"><span class="title" style="color: #a6a7a7; font-size: 16px;  padding: 3px; padding-bottom: 30px; display: inline-block; position: relative; z-index: 1; ">Hemos recibido tu solicitud<br> con el siguiente ticket</span><br><span class="valor" style="padding: 10px 10px 10px; border: 2px solid #98bf2e; font-size: 16px;width: 120px; display: inline-block; margin-top: -13px; position: relative; z-index: 0; color: #a6a7a7">sd020003</span></p></div>';
			$bodymail .='<p class="bienvenida" style="padding: 20px;text-align: center; color: #a6a7a7"><br> Empezaremos a trabajar en el de <span class="textverdecursiva" style="color: #98bf2e;font-size: 25px; font-weight: bold">inmediato</span><br></p>';
			$bodymail .='</div>';
