...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNames: [ "Enero","Febrero","Marzo","Abril","Mayo","Junio",
			"Julio","Agosto","Septiembre","Octubre","November","December" ], // Names of months for drop-down and formatting
		...
		dayNamesShort: [ "Dom", "Lun", "Mar", "Miér", "Jue", "Vie", "Sáb" ], // For formatting
