...
$headers = 'MIME-Version: 1.0' . "\r\n";
			...
			$bodymail .='<p style="line-height: 60px; margin: 0px;height: 80px; text-align: center;padding-top: 10px;"><img src="http://untrampolin.com/development/7clean/servicio_a_domicilio/images/logo3.png"></p>';
			$bodymail .='</header>';
			...
			$bodymail .='<p class="saludo" style="text-align: center;text-transform: capitalize;">¡Hola Gaby Frias!</p>';
			$bodymail .='<p class="bienvenida" style="padding: 20px;text-align: center; color: #fff"><br><span class="textverdecursiva" style="color: #98bf2e;font-size: 25px; font-weight: bold"> Bienvenido</span> a nuestra plataforma<br> de <span class="textobold" style="font-size: 22px;font-weight: bold;"> servicio a domicilio.</span><br></p>';
			...
			$bodymail .='<div class="content-datos2" style="width: 49%;display: inline-block;"><p style="text-align: center;"><span class="title" style="color: #98bf2e;font-size: 16px; background: #1874a7;width: 110px; padding: 3px; display: inline-block; position: relative; z-index: 1;">Contraseña</span><br><span class="valor" style=" color: #fff; padding: 10px 10px 10px; border: 2px solid #98bf2e; font-size: 14px;width: 120px; display: inline-block; margin-top: -13px; position: relative; z-index: 0;">12345678</span></p></div>';
			$bodymail .='</div>';
			$bodymail .='</div>';
			$bodymail .='<footer style="width: 598px;padding: 1px; background: #98bf2e; height: 30px;">';
			$bodymail .='<div class="content-footer footer_1" style="width: 49%;float: left;height: 100%;"><p class="face" style="margin:0px;line-height: 100%;height: 100%;padding: 0px 20px;text-align: left;"><a  href="https://www.facebook.com/tintorerias7clean/" target="_blank" style="color: #fff;text-decoration: none;font-size: 14px; height: 30px; line-height: 30px;"><img height="16px" src="http://untrampolin.com/development/7clean/servicio_a_domicilio/images/facebook.png" style="margin-bottom: 0px; margin-right: 5px;">Tintorerías 7Clean</a></p></div>';
